...
function getNetworkConfig(network: any) {
  if (['bsc', 'bsc-fork'].includes(network)) {
    ...
    return {
      ...
      oracles: ['0xc76dFb89fF298145b417d221B2c747d84952e01d', '0xACE5e348a341a740004304c2c228Af1A4581920F'],
      proxyAdminContract: '',
    }
  ...
  } else if (['hyperevm'].includes(network)) {
    console.log(`Deploying with ${network} config.`)
    return {
      wNative: '0x5555555555555555555555555555555555555555',
      nativeLiquidityThreshold: '3000000000000000000',
      priceGetter: '',
      factoryV2: '',
      factoryV3: '',
      factoryAlgebra: '',
      ...
      oracles: [
        '0x2b25BC41D55de29F3A2e163F8Eebf63966B25b57',
        '0xA0Adc43ce7AfE3EE7d7eac3C994E178D0620223B',
        '0x9114446540B4f8E0E310041981f7c1Be6181Ed07',
      ],
      proxyAdminContract: '',
    }
